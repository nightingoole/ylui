YL.static = {
  /** “关于”信息 */
  softwareName: '夜莺云桌面', //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.0", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: 'FourRoadTitans',//作者
  contactInformation: '937855602@qq.com',//联系方式
  officialWebsite: 'http://www.four-road-titans.xyz',//软件官网
  welcome: '本网站UI由 YLUI 强力驱动\n更多信息：//ylui.yuri2.cn',//加载完毕控制台提示信息
  copyrightDetail: 'four-road-titans copyright 2020',//版权详细信息
  otherStatements: '更多信息请关注夜莺云桌面',//其他信息（可留空）
  ...
  trustedApps: ['yl-server', 'ylui-login'], // 受信任的应用（可以使用敏感API）
